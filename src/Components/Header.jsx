...
class Header extends Component {
  ...
  toggleMenu = () => {
    document.getElementById("sub-Menu").classList.toggle("open-menu");
  }
  toggleMenuCompany = () => {
    document.getElementById("sub-Menu-comp").classList.toggle("open-menu");
  }
  render() {
    return (
      <>
        <nav className="navbar">
          ...
          <ul id="nav-list" className={this.state.clicked ? '#nav-list active' : 'nav-list'}>
            <div className="side-bar">
              <details>
                <summary onClick={this.toggleMenu}>Features <i id="sub-Menu" className="bx bx-chevron-down"></i></summary>
              ...
              <details>
                ...
                <summary onClick={this.toggleMenuCompany}>Company <i id="sub-Menu-comp" className="bx bx-chevron-down "></i></summary>
